...
import com.verselock.ui.LockScreenActivity
import com.verselock.util.lockScreenEnabledFlow
...
class LyricsService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_TRACK_CHANGED = "com.verselock.TRACK_CHANGED"
        private const val ACTION_PLAYBACK_STARTED = "com.verselock.PLAYBACK_STARTED"
        private const val ACTION_PLAYBACK_PAUSED = "com.verselock.PLAYBACK_PAUSED"
    ...
    private fun handleTrackChanged(track: TrackInfo) {
        ...
        serviceScope.launch {
            val app = applicationContext as verseLockApplication
    ...
    private fun createNotificationChannel() {
        val channel = NotificationChannel(
            ...
            description = "Keeps verseLock running in background"
            setShowBadge(false)
        }
